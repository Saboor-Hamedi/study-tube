import { Plus, Library, FileText, Maximize2, Trash2, Pencil, Check, ChevronLeft, ChevronRight, Hash, Folder, Calendar, Type } from 'lucide-react'
...
export default function Sidebar({ 
  ...
  const startRename = (name) => {
    setRenamingId(name)
    setNewCollectionName('') // Clear any creation state
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              {[
                ...
                { id: 'alpha', name: 'Alphabetical', icon: Type }
              ].map(item => (
