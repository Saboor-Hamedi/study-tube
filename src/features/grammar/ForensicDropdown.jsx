...
export default function ForensicDropdown({
  ...
  return (
    ...
    >
      <div className={`h-1 w-full ${getCategoryBg(selectedHl.type).replace("0.1", "1")}`} />
      <div className="p-3 space-y-3">
        {/* Compact Header with Integrated Apply Button */}
        <div className="flex items-center justify-between gap-2">
          <div className="flex flex-col">
            <span className={`text-[6px] font-black uppercase tracking-[0.15em] ${getCategoryColor(selectedHl.type)}`}>
              {selectedHl.reason}
            </span>
        ...
        <div className="space-y-2.5">
          <div className="p-2 bg-surface-3/30 border border-border/5 rounded-[6px] space-y-1.5">
            <div className="flex items-center justify-between gap-2">
              <span className="text-[6px] font-bold text-muted uppercase shrink-0">Orig</span>
            ...
            <div className="flex items-center justify-between gap-2">
              <span className="text-[6px] font-bold text-muted uppercase shrink-0">Fix</span>
