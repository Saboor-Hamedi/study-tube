    ...
    <div className="flex items-center relative" ref={profileRef}>
          ...
          >
            ...
            <div className="p-4 bg-surface-3 border-b border-border flex items-center gap-3">
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-[12px] font-black text-text uppercase tracking-tight truncate">
                  Saboor Hamedi
                </span>
            ...
            <div className="p-1.5 space-y-0.5">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-accent hover:bg-accent/10 transition-all rounded-[3px] bg-accent/10"
              >
      ...
      <button
        ...
        className={`group flex items-center gap-3 px-3 py-0 h-8 rounded-[12px] transition-all duration-300 ${
          isProfileOpen ? "bg-accent/10 shadow-sm" : "hover:bg-white/5"
        }`}
      >
        <div
        ...
        <div className="hidden lg:flex flex-col items-start text-left shrink-0 whitespace-nowrap">
          <span className="text-[10px] font-black text-text uppercase tracking-tight">
            Saboor Hamedi
          </span>
