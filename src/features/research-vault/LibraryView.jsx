              ...
              <div className="flex flex-col gap-4 overflow-hidden">
                <div className="flex justify-between items-start gap-3">
                  ...
                  <div className="flex items-center gap-1 shrink-0 pt-0.5">
                    ...
                    <button onClick={() => onExpand(v)} className="p-1.5 bg-slate-200 border border-slate-300 hover:bg-accent text-slate-600 hover:text-white transition-all rounded-[5px]" title="Neural Link">
                      <FileText className="h-3.5 w-3.5" />
                    </button>
                    <button onClick={() => setSelectedCard(v)} className="p-1.5 bg-slate-200 border border-slate-300 hover:bg-accent text-slate-600 hover:text-white transition-all rounded-[5px]" title="Maximize View">
