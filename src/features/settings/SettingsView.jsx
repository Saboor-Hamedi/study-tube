      ...
      <div className="max-w-6xl mx-auto space-y-10 pb-10">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-black text-text tracking-tighter flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-mono text-accent tracking-widest uppercase opacity-70">
                  v{version}
                </span>
            ...
            <p className="text-muted text-[11px] max-w-lg leading-relaxed font-medium opacity-60">
              Manage the high-fidelity neural core, local repository clusters,
              and architectural versioning.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm font-black text-text uppercase tracking-tight">
                    Intelligence Node
                  </h2>
                  <p className="text-[8px] text-accent font-black uppercase tracking-widest">
                    DeepSeek Neural Cluster
                  </p>
                </div>
              </div>
              <div className="text-right hidden sm:block">
                <span className="text-[9px] font-mono text-success block">
                  STATUS: ONLINE
                </span>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4 flex-1">
              <div className="space-y-2.5">
                <label className="text-[9px] font-black text-muted tracking-widest uppercase">
                ...
                <div className="flex flex-col sm:flex-row border border-border rounded-[5px] overflow-hidden focus-within:border-accent/40 transition-colors">
                  <div className="flex-1 bg-surface-3 px-4 py-3.5 flex items-center gap-3 min-w-0">
                    ...
                    <span className="text-[11px] text-text font-mono truncate tracking-tight">
                      {savePath || "Pending selection..."}
                    </span>
                  </div>
                  <button
              ...
              <div className="grid sm:grid-cols-[1fr,auto] items-center gap-6 p-5 bg-surface-2 border border-border relative">
                <div className="space-y-2">
                  ...
                  <p className="text-[9px] text-muted leading-relaxed uppercase tracking-wider font-semibold max-w-md">
                    {updateStatus === "downloaded"
                      ? "A new architectural layer is ready. Restart required."
                      : updateStatus === "available"
                        ? `Neural Shield Version ${updateInfo?.version || "N/A"} staged.`
                        : updateStatus === "downloading"
                          ? "Asynchronous acquisition active."
