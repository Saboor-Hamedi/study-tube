...
- ** Cinematic Player**: A custom-built player that puts the focus on the content and your learning tools.
- ** High-Quality Downloads**: Save videos locally with customizable quality (720p, 1080p, etc.) for offline study sessions.
...
- **Video Engine**: ytdl-core & yt-search.
...
1. **Clone the Repo**:
   ```bash
   git clone https://github.com/Saboor-Hamedi/study-tube.git
   ```
...
3. **Add Your AI Key**:
   - Open the app.
   - Click the **Gear (Settings)** icon in the sidebar.
   - Enter your **DeepSeek API Key**.
4. **Start Learning**:
   - Search for a video.
   - Open the **Study** or **AI Tutor** tab and enjoy!
